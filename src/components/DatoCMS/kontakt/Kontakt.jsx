...
export default function Kontakt({ content }) {
  ...
  return (
    <section className="grid lg:grid-cols-2 max-w-[1450px] mx-auto  ">
      <div className="relative px-6 sm:px-12 lg:px-16 xl:px-24  py-16 flex flex-col gap-8 max-w-2xl mx-auto bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url("/images/sabineLogoBaground.svg")` }}>
