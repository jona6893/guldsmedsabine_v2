...
function Parallax({content}) {
  ...
  return (
    <section className="pt-64 pb-40 relative mx-auto  grid justify-items-center">
      <div className="absolute w-full h-full top-0 left-0 bg-cover bg-center bg-no-repeat bg-fixed" style={{ backgroundImage: `url(${content.fotoParallax.url})` }}></div>
