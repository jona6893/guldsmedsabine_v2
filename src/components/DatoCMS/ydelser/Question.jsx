    ...
    <section className="mx-auto   p-4 flex flex-col justify-center items-center pb-20 pt-20">
      <article className="max-w-[1450px]">
        ...
        <div className=" flex max-[500px]:flex-col justify-around max-sm:gap-8 px-4">
          <Anchor className="bg-gold-dark text-offWhite rounded-full max-w flex items-center justify-center px-4  py-2" href={content.buttonOne[0].url}>
            {content.buttonOne[0].text}
          </Anchor>
          <Anchor className="text-gold-light border-gold-dark border-2 rounded-full max-w  flex items-center justify-center py-2 px-4" href={content.buttonTwo[0].url}>
