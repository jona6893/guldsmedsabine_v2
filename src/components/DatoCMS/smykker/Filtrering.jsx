    ...
    <div className="flex gap-4 items-start w-full justify-center ">
      <div className="flex flex-row gap-8 flex-wrap items-center">
        ...
        <label className="relative md:flex items-center gap-4">
          ...
          <select className="appearance-none rounded-full py-2 pl-8 pr-12 cursor-pointer bg-transparent border-2 border-gold-dark text-gold-light hover:bg-grey-dark hover:outline-none " onChange={() => handleMaterialeChange(event)}>
            <option value="Alle" className=" ">
              Alle
            </option>
